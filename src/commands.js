...
const commands = [
  ...
  new SlashCommandBuilder().setName('voice').setDescription('Manage your temporary voice room.')
    ...
    .addSubcommand(s=>s.setName('transfer').setDescription('Transfer ownership.').addUserOption(o=>o.setName('user').setDescription('New owner').setRequired(true))).addSubcommand(s=>s.setName('permit').setDescription('Allow a member into your room.').addUserOption(o=>o.setName('user').setDescription('Member').setRequired(true))).addSubcommand(s=>s.setName('reject').setDescription('Block a member from your room.').addUserOption(o=>o.setName('user').setDescription('Member').setRequired(true))).addSubcommand(s=>s.setName('kick').setDescription('Disconnect a member.').addUserOption(o=>o.setName('user').setDescription('Member').setRequired(true))).addSubcommand(s=>s.setName('disconnect').setDescription('Disconnect everyone else.'))
    .addSubcommand(s=>s.setName('bitrate').setDescription('Set the room bitrate in kbps.').addIntegerOption(o=>o.setName('kbps').setDescription('8-384 kbps').setRequired(true).setMinValue(8).setMaxValue(384))).addSubcommand(s=>s.setName('region').setDescription('Set the room voice region.').addStringOption(o=>o.setName('value').setDescription('auto or a Discord region').setRequired(true).setMaxLength(32))).addSubcommand(s=>s.setName('text').setDescription('Create or remove the private room text channel.').addBooleanOption(o=>o.setName('enabled').setDescription('Enabled').setRequired(true))).addSubcommand(s=>s.setName('delete').setDescription('Delete your temporary room now.')).addSubcommand(s=>s.setName('info').setDescription('Show room information.')),
